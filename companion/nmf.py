...
def decomposition(Q,
    ...
    **kwargs: dict
    ...
    # Model construction
    if mode == "Linear":
        model = NMF(sub_I.shape, n_components, initial_components=input_H, fix_components=fix_components)
    elif mode == "Deconvolutional":
        model = NMFD(sub_I.shape, n_components, T=kernel_width, initial_components=input_H,
...
def example_plot(sub_Q, sub_I, alphas, axes=None, sax=None, components=None, comax=None, cmap='tab10',
                 alt_ordinate=None, offset=1.,
                 summary_fig=False):
    """
